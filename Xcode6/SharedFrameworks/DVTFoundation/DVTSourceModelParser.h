...
- (unsigned long long)_acceptChildrenInScope:(id)arg1 atIndex:(unsigned long long)arg2 stackRange:(NSRange)arg3 node:(id)arg4;
- (id)_reduceToProduction:(id)arg1 stackRange:(NSRange)arg2 node:(id)arg3 inScope:(id)arg4;
...
- (id)parse:(id)arg1 withContext:(id)arg2 inputString:(id)arg3 range:(NSRange)arg4 dirtyRange:(NSRange *)arg5;
- (id)init;
