...
@property NSRange dirtyRange; // @synthesize dirtyRange=_dirtyRange;
...
- (id)itemNameAtLocation:(unsigned long long)arg1 inTypeList:(long long *)arg2 nameRanges:(id *)arg3 scopeRange:(NSRange *)arg4;
- (id)nameOfItem:(id)arg1 nameRanges:(id *)arg2 scopeRange:(NSRange *)arg3;
- (void)enumerateIdentifierItemsInRange:(NSRange)arg1 usingBlock:(CDUnknownBlockType)arg2;
